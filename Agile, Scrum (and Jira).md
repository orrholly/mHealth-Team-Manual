...
OK. Good point (says you). But how do I implement an Agile approach to my work? Well... there are many frameworks. We chose [Scrum](https://www.scrumalliance.org/why-scrum), but there are many other choices: (Kanban, Extreme Programming, Adaptive Software Development...). BTW - Tell us why would we should pivot to another... we are alway opens to change (agile). The moral of the story for this module is: 
